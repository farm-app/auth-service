package ru.rtln.authservice.service.impl;
...
import ru.rtln.authservice.redis.repository.RedisUserRepository;
import ru.rtln.authservice.service.AuthProvider;
import ru.rtln.common.security.keycloak.auth.TokenIntrospectModel;

import java.util.List;

import static ru.rtln.authservice.util.AuthConstant.BEARER;
import static ru.rtln.authservice.util.AuthConstant.CLIENT_ID;
import static ru.rtln.authservice.util.AuthConstant.CLIENT_SECRET;
import static ru.rtln.authservice.util.AuthConstant.GRANT_TYPE;
import static ru.rtln.authservice.util.AuthConstant.PASSWORD;
import static ru.rtln.authservice.util.AuthConstant.REFRESH_TOKEN;
import static ru.rtln.authservice.util.AuthConstant.SCOPE;
import static ru.rtln.authservice.util.AuthConstant.TOKEN;
import static ru.rtln.authservice.util.AuthConstant.USERNAME;
